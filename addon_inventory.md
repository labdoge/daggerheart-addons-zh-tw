...
| `daggerheart-kichwas-ui-refinement` | Daggerheart: Kichwas' UI Refinement | `1.3.0` | none seen | Hardcoded settings labels/hints. Prefer upstream i18n PR before any runtime patch. | Audited for metadata only |
